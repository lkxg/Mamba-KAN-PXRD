...
BF16 AMP, TensorBoard, and W&B offline logging. Checkpoints are
selected by:
...
Results are written to `experiments/e02_loss_ablation/results.csv` and
`experiments/e02_loss_ablation/results.md`.
